function helpfunc_general()
    ...
    printf("\n");
    printf("Syntax: dzero\n");
    printf("		Die aktuelle Datenmatrix wird auf der Y-Achse verschoben.\n");
    printf("		Die neue Datenmatrix enthaelt dann Werte um den Nullpunkt.\n");
    printf("\n");
    printf("\n");
    ...
    printf("		FUNKTION IST DERZEIT NICHT VERFUEGBAR\n\n");
    printf("\n");
